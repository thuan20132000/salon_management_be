    ...
    def handle(self, *args, **kwargs):
        services = [
            {'name': 'Basic Pedicure', 'description': 'Basic Pedicure service',
                'category': 'Pedicure & Manicure', 'price': 25.00, 'duration': timedelta(minutes=45)},
            {'name': 'Basic Manicure', 'description': 'Basic Manicure service',
                'category': 'Pedicure & Manicure', 'price': 20.00, 'duration': timedelta(minutes=30)},
            {'name': 'Kid Pedicure', 'description': 'Pedicure service for kids',
                'category': 'Kid Service', 'price': 15.00, 'duration': timedelta(minutes=30)},
            {'name': 'Kid Manicure', 'description': 'Manicure service for kids',
                'category': 'Kid Service', 'price': 10.00, 'duration': timedelta(minutes=20)},
            {'name': 'Acrylic Full Set', 'description': 'Acrylic nail extensions full set',
                'category': 'Nail Extensions', 'price': 40.00, 'duration': timedelta(minutes=90)},
            {'name': 'Gel Full Set', 'description': 'Gel nail extensions full set',
                'category': 'Nail Extensions', 'price': 35.00, 'duration': timedelta(minutes=75)},
            {'name': 'Paraffin Wax', 'description': 'Paraffin wax treatment',
                'category': 'Extra Services', 'price': 15.00, 'duration': timedelta(minutes=20)},
            {'name': 'Eyebrow Waxing', 'description': 'Eyebrow waxing service',
                'category': 'Waxing', 'price': 10.00, 'duration': timedelta(minutes=15)},
            {'name': 'Eyebrow Tint', 'description': 'Eyebrow tinting service',
                'category': 'Eyebrow Tinting', 'price': 12.00, 'duration': timedelta(minutes=20)},
            {'name': '30 Minute Block', 'description': '30 minutes of service time',
                'category': 'Block Time', 'price': 30.00, 'duration': timedelta(minutes=30)},
        ]
